...
def FilteringAnndata(
    adata, max_count=35000, min_count=5000, MT_propor=10, min_cell=10, imgPath="./"
):
    """
...
def Clustering(ann_data, infer_mode, savePath):
    ...
    if infer_mode == "ST":
        ...
        sc.pl.spatial(
            ann_data, img_key="hires", color=["leiden_clusters"], show=False, ax=axs[0]
        )
