...
#             scAnndata, pretrain_path=model_path, image_save_path=savePath_2
#         )
...
#         "prepare", help="Run data preprocessing and Gene Pair Selection"
#     )
#     parser_prep.add_argument(
#         "--scst_exp", required=True, help="Path to SC/ST expression data"
#     )
#     parser_prep.add_argument(
#         "--bulk_exp", required=True, help="Path to bulk expression data"
#     )
#     parser_prep.add_argument(
#         "--bulk_cli", required=True, help="Path to bulk clinical data"
#     )
#     parser_prep.add_argument(
#         "--datatype", required=True, choices=["SC", "ST"], help="Data type"
#     )
#     parser_prep.add_argument(
#         "--mode",
#         required=True,
#         choices=["Classification", "Cox", "Regression"],
#         help="Analysis mode",
#     )
#     parser_prep.add_argument("--save_path", required=True, help="Output directory")
#     parser_prep.add_argument(
#         "--lognormalize", action="store_true", help="Apply log normalization"
#     )
...
#         "run", help="Run tirank model training and inference"
#     )
#     parser_run.add_argument(
#         "--save_path", required=True, help="Output directory (must match prepare step)"
#     )
#     parser_run.add_argument("--datatype", required=True, choices=["SC", "ST"])
#     parser_run.add_argument(
#         "--mode", required=True, choices=["Classification", "Cox", "Regression"]
#     )
#     parser_run.add_argument("--device", default="cuda", help="Device (cuda/cpu)")
#     parser_run.add_argument(
#         "--tolerance", type=float, default=0.05, help="GMM tolerance"
#     )
